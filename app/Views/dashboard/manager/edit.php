...
<head>
    ...
    <title>Edit Item - Webuild Inventory</title>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="<?= site_url('inventory/view/' . $item['id']) ?>" class="btn btn-primary me-2">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= site_url('inventory/update/' . $item['id']) ?>" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="item_id" class="form-label">Item ID</label>
                                                <input type="text" class="form-control" id="item_id" name="item_id" 
                                                       value="<?= old('item_id', $item['item_id']) ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="warehouse_id" name="warehouse_id" required>
                                                    ...
                                                    <?php foreach ($warehouses as $id => $name): ?>
                                                        <option value="<?= $id ?>" 
                                                            <?= (old('warehouse_id', $item['warehouse_id']) == $id) ? 'selected' : '' ?>>
                                                            <?= esc($name) ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="<?= site_url('inventory/view/' . $item['id']) ?>" class="btn btn-secondary me-2">Cancel</a>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title mb-0">Current Item Info</h6>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                <h6 class="card-title mb-0">Edit Tips</h6>
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled">
                                    <li><i class="fas fa-info-circle text-warning"></i> Changes will be logged</li>
                                    <li><i class="fas fa-info-circle text-warning"></i> Stock movements require separate action</li>
                                    <li><i class="fas fa-info-circle text-warning"></i> Price changes affect inventory value</li>
                                </ul>
                            </div>
                        </div>
                    </div>
