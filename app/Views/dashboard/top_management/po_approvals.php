...
<head>
    <meta charset="UTF-8">
    <title><?= esc($title ?? 'PO Approvals') ?></title>
...
<div class="top-navbar bg-white py-3 px-4">
    <div class="d-flex justify-content-between align-items-center">
        <h2 class="mb-0"><i class="fas fa-file-invoice text-primary"></i> PO Approvals</h2>
        <div>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-2 sidebar d-none d-md-block">
            ...
            <a href="<?= site_url('top-management/po-approvals') ?>" class="active">
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="dashboard-widget">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="mb-0"><i class="fas fa-clock text-warning"></i> Pending POs (Awaiting Approval)</h5>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            <?php if (! empty($pos) && is_array($pos)): ?>
                                <?php foreach ($pos as $po): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" action="<?= site_url('top-management/po-approvals/' . ($po['id'] ?? 0) . '/approve') ?>" class="d-inline">
                                                <?= csrf_field() ?>
                                                <input type="hidden" name="po_approval_notes" value="">
                                                <button type="submit" class="btn btn-sm btn-success">Approve</button>
                                            </form>
                                            <form method="post" action="<?= site_url('top-management/po-approvals/' . ($po['id'] ?? 0) . '/reject') ?>" class="d-inline">
                                                <?= csrf_field() ?>
                                                <input type="hidden" name="po_approval_notes" value="">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" class="text-center text-muted py-4">No pending POs found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
