...
/**
 * Migration: Create Accounts Receivable Table
 * 
 * Stores client invoices and receivable amounts
 */
    ...
    public function up()
    {
        $this->forge->addField([
            ...
            'balance' => [
                'type'       => 'DECIMAL',
                'constraint' => '15,2',
                'comment'    => 'Remaining amount to collect',
            ],
            'status' => [
                'type'       => 'ENUM',
            ...
            'warehouse_id' => [
                ...
                'unsigned'   => true,
                'null'       => true,
                'comment'    => 'Source warehouse (if material sale)',
            ],
            'created_by' => [
                'type'       => 'INT',
                'constraint' => 11,
